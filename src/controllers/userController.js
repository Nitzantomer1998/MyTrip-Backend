  ...
  try {
    ...
    if (userExist) {
      ...
      await Post.updateMany(
        { 'originalUser.username': req.user.username },
        { $set: { 'originalUser.username': req.params.username } }
      );

      await Post.updateMany(
        { 'sharingUser.username': req.user.username },
        { $set: { 'sharingUser.username': req.params.username } }
      );
